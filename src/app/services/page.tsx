      ...
      <section className="py-16 bg-secondary">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-serif text-primary mb-6">Adventures Await</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className="bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 group">
                ...
                <div className="p-8">
                  ...
                  <div className="flex gap-4 mb-6 text-xs">
                    <div>
                      <span className="text-accent uppercase tracking-wider font-bold">Duration:</span>
                      <span className="text-gray-600 ml-2">{service.duration}</span>
                    </div>
                    <div>
                      <span className="text-accent uppercase tracking-wider font-bold">Level:</span>
                      <span className="text-gray-600 ml-2">{service.difficulty}</span>
                    </div>
                  </div>
                  
                  <button 
                    onClick={() => handleInquiry(service.title)}
                    className="text-accent text-xs uppercase tracking-widest hover:text-primary transition-colors border-b border-accent pb-1 cursor-pointer"
                  >
                    Inquire on WhatsApp
                  </button>
                </div>
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h4 className="text-accent uppercase tracking-[0.2em] text-xs font-bold mb-4">Additional Services</h4>
            <h2 className="text-3xl md:text-4xl font-serif text-primary">More to Explore</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="font-serif text-primary mb-2">Local Shopping</h3>
              <p className="text-sm text-gray-600">Handicrafts & souvenirs</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif text-primary mb-2">Guided Tours</h3>
              <p className="text-sm text-gray-600">Temple & cultural tours</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif text-primary mb-2">Photography</h3>
              <p className="text-sm text-gray-600">Professional photo tours</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif text-primary mb-2">Cultural Programs</h3>
              <p className="text-sm text-gray-600">Local music & dance</p>
            </div>
          </div>
        </div>
      </section>
